...
public class AbstractGraph<V> implements Graph<V> {
    ...
    public class Tree{
        ...
        public List<org.example.GraphDesign.V> getPath(int index){
            ArrayList<org.example.GraphDesign.V> path = new ArrayList<>();

            do{
                path.add((org.example.GraphDesign.V) vertices.get(index));
                index = parent[index];
            }while(index != -1);
            return path;
        }
        public void printPath(int index){
            List<org.example.GraphDesign.V> path = getPath(index);
